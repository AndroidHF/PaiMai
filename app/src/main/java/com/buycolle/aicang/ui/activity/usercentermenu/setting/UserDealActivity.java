 ...
 */
public class UserDealActivity extends CommenWebActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myHeader.init("用户协议", new MyHeader.Action() {
            @Override
    ...
    private void loadData() {
        mApplication.apiClient.writer_getuseragreerbyapp(new JSONObject(), new ApiCallback() {
            @Override
