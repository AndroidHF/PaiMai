 ...
 */
public class AskAndQuestionActivity extends BaseActivity implements SmileFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paiPinDetailBean = (PaiPinDetailBean) _Bundle.getSerializable("entity");
        initTop();
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup viewGroup) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(mContext).inflate(R.layout.row_ask_question_item, viewGroup, false);
...
//                holder.tv_aws_content.setText(subEntity.getContext());
                ...
                mApplication.apiClient.commoncomment_submitforproductbyapp(jsonObject, new ApiCallback() {
                    ...
                    public void onApiSuccess(String response) {
                        ...
                        try {
                            JSONObject resultObj = new JSONObject(response);
                            if (JSONUtil.isOK(resultObj)) {
                                if (paiPinAskAndQsqBeens.size() > 0) {
                                    list.setSelection(0);
                                }
                                pageIndex = 1;
                                loadData(false);
