...
import com.buycolle.aicang.ui.view.mainScrole.ScrollableHelper;
 ...
 */
public class SubjectFragment extends ScrollAbleFragment implements ScrollableHelper.ScrollableContainer{
    ...
    public static SubjectFragment newInstance(int event_id) {
        SubjectFragment listFragment = new SubjectFragment();
        Bundle bundle = new Bundle();
        bundle.putInt("position", event_id);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        event_id = getArguments().getInt("position");
    ...
    private void loadData(int event_id, final boolean isLoadMore, final boolean isAction) {
        ...
        mApplication.apiClient.appEvent_getEventProductListByApp(jsonObject, new ApiCallback() {
            @Override
...
//                    resultArray.get(i).setTime(StringFormatUtil.getDaoJiShiTime(resultArray.get(i).getPm_end_time()));
    ...
    public void refreshByState(int state, boolean isAction) {
        ...
        event_id = state ;
        pageIndex = 1;
        loadData(event_id, false, isAction);
    }
}
