...
import com.buycolle.aicang.ui.activity.CommenWebActivity;
 ...
 */
public class AboutUsActivity extends CommenWebActivity {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        myHeader.init("关于我们", new MyHeader.Action() {
            @Override
    ...
    private void loadData() {
        mApplication.apiClient.copywriter_getaboutusbyapp(new JSONObject(), new ApiCallback() {
            @Override
