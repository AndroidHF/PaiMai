 ...
 */
public class PaiMaiJiaoYiLiuChengActivity extends CommenWebActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        myHeader.init("交易流程", new MyHeader.Action() {
            @Override
    ...
    private void loadData() {
        mApplication.apiClient.copywriter_getjiaoyilcbyapp(new JSONObject(), new ApiCallback() {
            @Override
