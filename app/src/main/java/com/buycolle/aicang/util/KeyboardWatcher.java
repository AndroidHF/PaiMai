...
public class KeyboardWatcher {
    ...
    private class GlobalLayoutListener implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        public void onGlobalLayout() {
            ...
            KLog.d("-initialValue---","initialValue=="+initialValue);
            KLog.d("-rootViewRef.get().getHeight()---","rootViewRef.get().getHeight()=="+rootViewRef.get().getHeight());
            KLog.d("-hasSentInitialAction---","hasSentInitialAction=="+hasSentInitialAction);
            KLog.d("-isKeyboardShown---","isKeyboardShown=="+isKeyboardShown);
